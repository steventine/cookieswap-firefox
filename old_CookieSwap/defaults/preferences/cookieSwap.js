...
pref("extensions.cookieswap.options.MenuEnable.cookieswap-menu-help", true);

//What menu items to enable...About
pref("extensions.cookieswap.options.MenuEnable.cookieswap-menu-about", true);

//Defines if we should display the active profile in the toolbar or not
pref("extensions.cookieswap.options.profileUI.DisplayProfileNameInToolbar", true);

//Is this the first time CookieSwap has run after support for the toolbar was added?
//  If yes, then we install the toolbar by default.  If users remove it, we won't
//  ever re-add it.
pref("extensions.cookieswap.firstToobarRun", true);
